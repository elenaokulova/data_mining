...
class Post(Base):
    ...
    tags = relationship('Tag', secondary=tag_post, lazy='dynamic', backref='tags')
...
class Tag(Base):
    ...
    posts = relationship('Post', secondary=tag_post, lazy='dynamic', backref='posts')
...
class Comment(Base):
    ...
    author = Column(Text, nullable=True, unique=False)
